from flask import Flask, render_template, request, flash, get_flashed_messages, jsonify, redirect, make_response
...
def translate():
    ...
    translator= Translator(from_lang=Language[request.form['from_language']], to_lang=request.form['to_language'])
    return jsonify(result=translator.translate(request.form['text']))
